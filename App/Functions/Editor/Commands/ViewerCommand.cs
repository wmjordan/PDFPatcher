...
namespace PDFPatcher.Functions.Editor
{
	sealed class ViewerCommand : IEditorCommand
	{
		...
		static readonly string[] __commands = {
			...
			"_ShowTextBorders", "_DarkMode", "_GreenMode", "_ShowBookmarks", "_ShowAnnotations",
			"_OcrDetectPunctuation", "_FullScreen", "_EditorOptions"
		};
		...
		public void Process(Controller controller, params string[] parameters) {
			...
			switch (_command) {
				...
				case "_ScrollVertical":
					v.ContentDirection = Editor.ContentDirection.TopToDown;
					break;
				case "_ScrollHorizontal":
					v.ContentDirection = Editor.ContentDirection.RightToLeft;
					break;
				...
				case "_InvertColor":
					...
					break;
				case "_MoveMode":
					v.MouseMode = Editor.MouseMode.Move;
					break;
				case "_SelectionMode":
					v.MouseMode = Editor.MouseMode.Selection;
					break;
