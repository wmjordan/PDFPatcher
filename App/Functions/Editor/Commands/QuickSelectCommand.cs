...
namespace PDFPatcher.Functions.Editor
{
	sealed class QuickSelectCommand : IEditorCommand
	{
		...
		static readonly MatchPattern[] __commands = {
			new MatchPattern("^" + __S + "第" + __S + __N + __S + "(?:部分|部)|^" + __S + "part" + __S + "[0-9]", false,
				false, true) {Name = "“第N部分”"},
			new MatchPattern("^" + __S + "第" + __S + __N + __S + "[篇卷]|^" + __S + "(?:volume|vol)" + __S + "[0-9]",
				false, false, true) {Name = "“第N篇”或“第N卷”"},
			new MatchPattern("^" + __S + "第" + __S + __N + __S + "章|^" + __S + "chapter" + __S + "[0-9]", false, false,
				true) {Name = "“第N章”"},
			new MatchPattern("^" + __S + "第" + __S + __N + __S + "节|^" + __S + "section" + __S + "[0-9]", false, false,
				true) {Name = "“第N节”"},
			...
			new MatchPattern("^" + __S + __ND + __ND + __ND + __ND + "?" + __NN, true, false, true) {
				Name = "“N.N.N.N”模式"
			},
			new MatchPattern("^" + __S + __ND + __ND + __ND + __ND + __ND + "?" + __NN, true, false, true) {
				Name = "“N.N.N.N.N”模式"
			}
		};
