...
internal sealed class QuickSelectCommand : IEditorCommand
{
	...
	private static readonly MatchPattern[] __commands = {
		new("^" + __S + "第" + __S + __N + __S + "(?:部分|部)|^" + __S + "part" + __S + "[0-9]", false,
			false, true) {Name = "“第N部分”"},
		new("^" + __S + "第" + __S + __N + __S + "[篇卷]|^" + __S + "(?:volume|vol)" + __S + "[0-9]",
			false, false, true) {Name = "“第N篇”或“第N卷”"},
		new("^" + __S + "第" + __S + __N + __S + "章|^" + __S + "chapter" + __S + "[0-9]", false, false,
			true) {Name = "“第N章”"},
		new("^" + __S + "第" + __S + __N + __S + "节|^" + __S + "section" + __S + "[0-9]", false, false,
			true) {Name = "“第N节”"},
