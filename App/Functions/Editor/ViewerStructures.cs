...
readonly struct TextInfo(Page page, MuRectangle bbox, List<TextLine> textLines, List<TextSpan> spans)
{
	public readonly Page Page = page;

	/// <summary>获取文本字符的位置边框。</summary>
	public readonly MuRectangle TextBBox = bbox;
	/// <summary>获取文本位置以下的文本行。</summary>
	public readonly List<TextLine> Lines = textLines;
	public readonly List<TextSpan> Spans = spans;
