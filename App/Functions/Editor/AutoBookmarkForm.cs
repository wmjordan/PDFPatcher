...
sealed partial class AutoBookmarkForm : DraggableForm
{
	...
	void OnLoad() {
		...
		AppContext.MainForm.FunctionControlChanged += MainForm_FunctionControlChanged;
	}
	...
	void MainForm_FunctionControlChanged(object sender, EventArgs<FunctionControl> e) {
		Close();
	}
