...
{
	private ExporterOptions _expOptions;
	private ImporterOptions _impOptions;
	private bool locked;
	...
	public void Reload() {
		...
		int i = _UnitBox.Items.IndexOf(_expOptions.UnitConverter.Unit);
	...
	private void _EncodingBox_Leave(object sender, EventArgs e) {
		try {
	...
	private void _ExtractPageRangeBox_Leave(object sender, EventArgs e) {
