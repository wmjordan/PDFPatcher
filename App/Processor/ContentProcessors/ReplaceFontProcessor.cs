...
namespace PDFPatcher.Processor
{
	...
	{
		static readonly string[] __LegacyFonts = {
		...
		static void WriteCidWidths(NewFont font, PdfDictionary fontDictionary) {
			...
			for (i = 0; i < l; i++) {
				...
				var i2 = i;
				id2 = id;
				var wl = new PdfArray {new PdfNumber(width)};
		...
		static PdfStream SubsetFont(NewFont ef, TrueTypeFontUnicode ttf) {
			...
			if (ttf.Cff) {
				...
				var ts = new TrueTypeFontSubSet(ttf.FileName, new RandomAccessFileOrArray(ttf.FileName),
