...
namespace PDFPatcher.Processor
{
	sealed class ImportOcrResultProcessor : IDocProcessor
	{
		...
		public string Name { get { return "导入光学字符识别结果"; } }
		...
		private void CreateGlobalOcrFontReference (DocProcessorContext context) {
			...
			this.font = CreateOcrFont (context, d, false);
			this.fontV = CreateOcrFont (context, d, true);
		}
		...
		sealed class OcrContentInfo
		{
			...
			internal int DeltaX { get { return _dx; } }
			internal int DeltaY { get { return _dy; } }
			internal bool IsVertical { get { return _isVertical; } }
			internal float FontSize { get { return _size; } }
