...
namespace MuPdfSharp
{
	...
	static class Interop
	{
		...
		static class NativeLinkedList<T> where T : struct, Interop.ILinkedList
		{
			...
			sealed class LinkedListEnumerable<Node> : IEnumerable<NativeObject<Node>>
				where Node : struct, Interop.ILinkedList
			{
			...
			sealed class LinkedListEnumerator<Node> : IEnumerator<NativeObject<Node>>
				where Node : struct, Interop.ILinkedList
			{
