...
internal partial class NativeMethods
{
	...
	private static extern IntPtr ToStringBytes(ContextHandle context, IntPtr obj);

	[DllImport(DLL, CallingConvention = CC.Cdecl, EntryPoint = "pdf_to_str_len")]
	private static extern int ToStringLength(ContextHandle context, IntPtr obj);

	public static string ToString(ContextHandle context, IntPtr obj) {
		IntPtr b = ToStringBytes(context, obj);
		int l = ToStringLength(context, obj);
	...
	private static extern int ToIndirectNum(ContextHandle context, IntPtr obj);

	[DllImport(DLL, CallingConvention = CC.Cdecl, EntryPoint = "pdf_to_gen")]
	private static extern int ToIndirectGen(ContextHandle context, IntPtr obj);
	...
	private static readonly ushort[] pdf_doc_encoding = {
		/* 0x0 to 0x17 except \t, \n and \r are really undefined */ 0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07,
		0x08, 0x09, 0x0A, 0x0B, 0x0C, 0x0D, 0x0E, 0x0F, 0x10, 0x11, 0x12, 0x13, 0x14, 0x15, 0x16, 0x17, 0x02d8, 0x02c7,
		0x02c6, 0x02d9, 0x02dd, 0x02db, 0x02da, 0x02dc, 0x0020, 0x0021, 0x0022, 0x0023, 0x0024, 0x0025, 0x0026, 0x0027,
		...
		0x007c, 0x007d, 0x007e, 0x0000, 0x2022, 0x2020, 0x2021, 0x2026, 0x2014, 0x2013, 0x0192, 0x2044, 0x2039, 0x203a,
		0x2212, 0x2030, 0x201e, 0x201c, 0x201d, 0x2018, 0x2019, 0x201a, 0x2122, 0xfb01, 0xfb02, 0x0141, 0x0152, 0x0160,
		0x0178, 0x017d, 0x0131, 0x0142, 0x0153, 0x0161, 0x017e, 0x0000, 0x20ac, 0x00a1, 0x00a2, 0x00a3, 0x00a4, 0x00a5,
		0x00a6, 0x00a7, 0x00a8, 0x00a9, 0x00aa, 0x00ab, 0x00ac, 0x0000, 0x00ae, 0x00af, 0x00b0, 0x00b1, 0x00b2, 0x00b3,
