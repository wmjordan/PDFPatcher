...
namespace MuPdfSharp
{
	...
	public unsafe class MuPdfObject
	{
		...
		NativeObject* NativePointer { get { return (NativeObject*)_object; } }
		internal IntPtr Pointer { get { return _object; } }
		...
		public MuPdfObjectKind Kind {
			get { return Pointer == IntPtr.Zero ? MuPdfObjectKind.PDF_NULL : (MuPdfObjectKind)NativePointer->_kind; }
		}

		/// <summary>返回对象的引用数量。</summary>
		internal int ReferenceCount {
			get { return Pointer == IntPtr.Zero ? 0 : NativePointer->_referenceCount; }
		}
		...
		public bool BooleanValue {
			get { return NativeMethods.ToBoolean (_context, _object) != 0; }
		}
		public int IntegerValue {
			get { return NativeMethods.ToInteger (_context, _object); }
		}
		public float FloatValue {
			get { return NativeMethods.ToSingle (_context, _object); }
		}
		public string NameValue {
			get { return NativeMethods.ToName (_context, _object); }
		}
		public string StringValue {
			get { return NativeMethods.ToString (_context, _object); }
		}
		public bool IsNull { get { return NativeMethods.IsNull(_context, _object) != 0; } }
		public bool IsArray {
			get { return NativeMethods.IsArray (_context, _object) != 0; }
		}
		public bool IsDictionary {
			get { return NativeMethods.IsDictionary (_context, _object) != 0; }
		}
...
#pragma warning restore 649, 169
	...
	{
		NativeDict* NativePointer { get { return (NativeDict*)Pointer; } }

		internal MuPdfDictionary (ContextHandle context, IntPtr obj)
			: base (context, obj) {
		}

		public int Capacity { get { return Pointer == IntPtr.Zero ? 0 : NativePointer->_capacity; } }

		/// <summary>
		/// 获取字典中的项目数量。
		/// </summary>
		public int Count { get { return Pointer == IntPtr.Zero ? 0 : NativePointer->_length; } }

		public KeyValuePair<string, MuPdfObject> this[int index] {
			get {
				return new KeyValuePair<string, MuPdfObject> (
		...
		public MuPdfObject this[string key] {
			get { return new MuPdfObject (Context, NativeMethods.Get (Context, Pointer, key)); }
...
#pragma warning restore 649
	...
	{
		NativeArray* NativePointer { get { return (NativeArray*)Pointer; } }
		...
		public MuPdfObject this[int index] {
			get { return new MuPdfObject (Context, NativeMethods.GetArrayItem (Context, Pointer, index)); }
...
#pragma warning restore 649
	...
	{
		NativeRef* NativePointer { get { return (NativeRef*)Pointer; } }

		public int Number { get { return NativePointer->_Num; } }
		public int Generation { get { return NativePointer->_Generation; } }
