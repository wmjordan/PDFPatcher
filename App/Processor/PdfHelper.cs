...
namespace PDFPatcher.Processor
{
	internal static class PdfHelper
	{
		...
		private static DualKeyDictionary<PdfName, string> InitPdfNameMap () {
			...
			m.Add (PdfName.PAGELAYOUT, Constants.PageLayout);

			m.Add (PdfName.PAGEMODE, Constants.PageMode);

			m.Add (PdfName.DIRECTION, Constants.ViewerPreferencesType.Direction);

			m.Add (PdfName.ST, Constants.PageLabelsAttributes.StartPage);
			m.Add (PdfName.P, Constants.PageLabelsAttributes.Prefix);
			m.Add (PdfName.S, Constants.PageLabelsAttributes.Style);

			m.Add (PdfName.XYZ, Constants.DestinationAttributes.ViewType.XYZ);
			m.Add (PdfName.FIT, Constants.DestinationAttributes.ViewType.Fit);
			m.Add (PdfName.FITB, Constants.DestinationAttributes.ViewType.FitB);
			m.Add (PdfName.FITBH, Constants.DestinationAttributes.ViewType.FitBH);
			m.Add (PdfName.FITBV, Constants.DestinationAttributes.ViewType.FitBV);
			m.Add (PdfName.FITH, Constants.DestinationAttributes.ViewType.FitH);
			m.Add (PdfName.FITR, Constants.DestinationAttributes.ViewType.FitR);
			m.Add (PdfName.FITV, Constants.DestinationAttributes.ViewType.FitV);

			m.Add (PdfName.GOTO, Constants.ActionType.Goto);
			m.Add (PdfName.GOTOR, Constants.ActionType.GotoR);
			m.Add (PdfName.LAUNCH, Constants.ActionType.Launch);
			m.Add (PdfName.URI, Constants.ActionType.Uri);
