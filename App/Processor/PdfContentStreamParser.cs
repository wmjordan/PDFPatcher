...
namespace PDFPatcher.Processor
{
	internal class PdfContentStreamProcessor
	{
		...
		// Methods
		internal Model.GraphicsState CurrentGraphicState {
			get { return gsStack.Peek (); }
		}
		internal Matrix TextMatrix {
			get { return _TextMatrix; }
		}
		internal IContentOperator DefaultOperator { get; set; }
		protected IDictionary<int, string> Fonts => _FontNameCache;
		protected ResourceDictionary Resource { get { return _Resources; } }
		...
		{
			// Fields
			private IContentOperator showText;
			private IContentOperator textMoveNextLine;
		...
		{
			// Fields
			private IContentOperator moveNextLineAndShowText;
			private IContentOperator setTextCharacterSpacing;
			private IContentOperator setTextWordSpacing;
