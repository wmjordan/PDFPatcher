...
namespace PDFPatcher
{
	public class AutoBookmarkOptions
	{
		...
		private Collection<MatchPattern> _IgnorePatterns = new Collection<MatchPattern> ();
		/// <summary>
		/// 忽略指定的表达式。
		/// </summary>
		[XmlArray ("忽略表达式")]
		[XmlArrayItem ("表达式")]
		public Collection<MatchPattern> IgnorePatterns { get { return _IgnorePatterns; } }

		private Collection<LevelAdjustmentOption> _LevelAdjustment = new Collection<LevelAdjustmentOption> ();
		[XmlElement ("级别调整")]
		[PowerJson.JsonField ("级别调整")]
		public Collection<LevelAdjustmentOption> LevelAdjustment { get { return _LevelAdjustment; } }
