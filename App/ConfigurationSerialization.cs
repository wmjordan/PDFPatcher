...
{
	[XmlAttribute("检查更新时间")] public DateTime CheckUpdateDate { get; set; }

	[XmlAttribute("检查更新间隔")] public int CheckUpdateInterval { get; set; } = 14;

	[XmlAttribute("保存程序设置")] public bool SaveAppSettings { get; set; }

	[XmlAttribute("文档加载模式")] public string PdfLoadMode { get; set; }
	...
	[XmlElement("PDF文档设置")] public PatcherOptions PatcherOptions { get; set; }
