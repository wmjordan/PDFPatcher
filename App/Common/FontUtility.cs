...
namespace PDFPatcher.Common
{
	...
	{
		static Regex _italic = new Regex (" (?:Italic|Oblique)$", RegexOptions.CultureInvariant | RegexOptions.IgnoreCase);
		static Regex _bold = new Regex (" Bold$", RegexOptions.CultureInvariant | RegexOptions.IgnoreCase);
		static Regex _boldItalic = new Regex (" Bold (?:Italic|Oblique)$", RegexOptions.CultureInvariant | RegexOptions.IgnoreCase);
		...
		internal struct FriendlyFontName : IComparable<FriendlyFontName>
		{
			...
			public FriendlyFontName (string originalName, string displayName) {
				...
				this.DisplayName = displayName != originalName ? displayName : null;
			}
